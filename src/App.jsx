    ...
    <div className="relative min-h-screen overflow-hidden text-ivory">
      ...
      <main>
        <section id="home" className="relative min-h-screen overflow-hidden pt-28">
          ...
          <div className="section-shell relative grid min-h-[calc(100svh-7rem)] items-center gap-10 pb-14 md:gap-12 md:pb-16 lg:grid-cols-[1fr_0.92fr]">
            <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9 }}>
              <div className="mb-6 inline-flex max-w-full items-center gap-2 rounded-full border border-gold/25 bg-white/5 px-3 py-2 text-[0.66rem] font-bold uppercase tracking-[0.12em] text-gold sm:gap-3 sm:px-4 sm:text-xs sm:tracking-[0.22em]">
                <Cross className="h-4 w-4 shrink-0" />
                <span className="truncate">Jesus Christ • Miracles • Nations</span>
              </div>
              <h1 className="font-display text-[3.15rem] font-bold leading-[0.95] sm:text-7xl lg:text-8xl">
            ...
            <motion.div
              className="relative mx-auto w-full max-w-sm sm:max-w-lg lg:max-w-xl"
            ...
            >
              ...
              <img
                ...
                className="relative z-10 w-full rounded-2xl object-cover shadow-halo ring-1 ring-gold/30 animate-float sm:rounded-[2rem]"
              />
            </motion.div>
          </div>
        </section>

        <AnimatedSection id="about" className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell grid items-center gap-10 lg:grid-cols-[0.85fr_1.15fr]">
            <Card className="p-7 sm:p-9">
              <p className="text-[0.68rem] font-extrabold uppercase tracking-[0.2em] text-gold sm:text-xs sm:tracking-[0.32em]">Divine Mandate</p>
              <h2 className="mt-4 font-display text-3xl font-bold leading-tight text-ivory sm:text-4xl lg:text-5xl">
        ...
        <AnimatedSection id="vision" className="py-16 sm:py-20 lg:py-24">
        ...
        <AnimatedSection className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell">
            <Card className="grid items-center gap-8 overflow-hidden p-7 sm:p-10 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              <div>
                <p className="text-[0.68rem] font-extrabold uppercase tracking-[0.2em] text-gold sm:text-xs sm:tracking-[0.32em]">Founder / Servant of God</p>
                <h2 className="mt-4 font-display text-3xl font-bold text-ivory sm:text-4xl lg:text-5xl">
                  François Mutombo
                </h2>
                ...
                <p className="mt-6 text-base leading-8 text-ivory/72">
                  A servant of God entrusted with the prophetic and evangelical vision of Many Miracles Ministries, called to announce Christ and lead souls toward divine transformation through prayer, the Word and the power of the Holy Spirit.
                </p>
              </div>
            </Card>
          </div>
        ...
        <AnimatedSection id="sermons" className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell">
            ...
            <div className="mt-14 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
              {sermons.map(({ title, meta, text, icon: Icon }) => (
                <Card key={title} className="flex min-h-72 flex-col p-6">
                  ...
                  <p className="mt-6 text-[0.68rem] font-extrabold uppercase tracking-[0.16em] text-gold/80 sm:text-xs sm:tracking-[0.22em]">{meta}</p>
        ...
        <AnimatedSection id="prayer" className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <Card className="p-6 sm:p-8">
              <form className="grid gap-4">
                ...
                <button className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-gold via-amberfire to-gold px-5 py-3 text-xs font-extrabold uppercase tracking-[0.08em] text-midnight transition hover:-translate-y-1 hover:shadow-halo sm:px-6 sm:text-sm sm:tracking-[0.16em]">
        ...
        <AnimatedSection id="events" className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell">
                ...
                <Card key={event.title} className="p-6">
                  <div className="flex flex-col gap-5 sm:flex-row">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs font-bold uppercase tracking-[0.1em] text-gold sm:text-sm sm:tracking-[0.18em]">{event.date} • {event.place}</p>
        ...
        <AnimatedSection className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell grid items-center gap-10 lg:grid-cols-[1fr_1fr]">
            ...
            <div className="relative min-h-[22rem] overflow-hidden rounded-2xl border border-gold/20 bg-[radial-gradient(circle_at_center,rgba(248,199,90,.20),rgba(18,63,117,.28)_42%,rgba(5,8,18,.9)_70%)] p-6 shadow-halo sm:min-h-96 sm:rounded-[2rem] sm:p-8">
              ...
              {['Africa', 'Europe', 'America', 'Asia'].map((place, index) => (
                <span
                  key={place}
                  className="absolute rounded-full border border-gold/25 bg-midnight/80 px-2.5 py-1 text-[0.62rem] font-bold uppercase tracking-[0.1em] text-gold sm:px-3 sm:text-xs sm:tracking-[0.18em]"
                  style={{
                    left: `${18 + index * 19}%`,
                    top: `${24 + (index % 2) * 42}%`,
                  }}
        ...
        <AnimatedSection id="partnership" className="py-16 sm:py-20 lg:py-24">
          <div className="section-shell">
              <div className="relative overflow-hidden rounded-2xl border border-gold/25 bg-gradient-to-br from-gold/18 via-royal/70 to-midnight p-6 shadow-halo sm:rounded-[2rem] sm:p-12 lg:p-16">
              <div className="absolute right-0 top-0 h-72 w-72 rounded-full bg-gold/20 blur-3xl" aria-hidden="true" />
              <div className="relative max-w-3xl">
                <p className="text-[0.68rem] font-extrabold uppercase tracking-[0.2em] text-gold sm:text-xs sm:tracking-[0.32em]">Donation / Partnership</p>
                <h2 className="mt-4 font-display text-3xl font-bold text-ivory sm:text-5xl lg:text-6xl">Partner With The Vision</h2>
          ...
          <div className="section-shell grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <Card className="p-6 sm:p-8">
              <form className="grid gap-4">
                ...
                <Field as="textarea" placeholder="Message" rows={5} />
                <button className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-gold/35 bg-white/5 px-5 py-3 text-xs font-extrabold uppercase tracking-[0.08em] text-gold transition hover:-translate-y-1 hover:bg-gold hover:text-midnight sm:px-6 sm:text-sm sm:tracking-[0.16em]">
